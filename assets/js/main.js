...
function viewport() {
  var a = window,
    b = "inner";
  return (
    "innerWidth" in window || ((b = "client"), (a = document.documentElement || document.body)), { width: a[b + "Width"], height: a[b + "Height"] }
  );
}
// viewport size end
...
function initializeMap() {
  var map = new google.maps.Map(document.getElementById("map"), {
    ...
    styles: [
      ...
      { featureType: "landscape", elementType: "all", stylers: [{ saturation: -100 }, { lightness: 0 }, { visibility: "on" }] },
      ...
      { featureType: "water", elementType: "geometry", stylers: [{ hue: "#ffff00" }, { lightness: 0 }, { saturation: -97 }] },
      { featureType: "water", elementType: "labels", stylers: [{ lightness: 0 }, { saturation: -100 }] },
    ],
  });
  ...
  marker = new google.maps.Marker({
    position: new google.maps.LatLng(40.7139741, -73.9961234),
    map: map,
    icon: image,
  });
...
function loadScript() {
  ...
  script.src =
    "https://maps.googleapis.com/maps/api/js?key=AIzaSyAnKLwP33l9NYKvibgdPwBLl5zlVqYTr1M&" + "map_ids=d8b96138e75850a&" + "callback=initializeMap";
  setTimeout(function () {
...
window.onload = function () {
  ...
  (function () {
    ...
    jQuery(".js-popup-open").on("click", function (e) {
      e.preventDefault();
      var currentId = jQuery(this).attr("href") || jQuery(this).attr("data-href");
      timerOut(timer);
      ...
      if (jQuery(this).hasClass("js-popup-video")) {
        ...
        jQuery(".js-video-frame").find("iframe").attr("src", videoSrc).attr("width", videoWidth).attr("height", videoHeight);
